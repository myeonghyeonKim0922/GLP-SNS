...
public class MediaService {
	...
	//이미지 업데이트 메소드
	public void updateItemImg(Long mediaId, MultipartFile itemImgFile) throws Exception {
		if(!itemImgFile.isEmpty()) { //파일이 있으면
			Media savedItemImg = mediaRepository.findById(mediaId).orElseThrow(EntityNotFoundException::new);
